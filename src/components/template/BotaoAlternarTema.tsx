...
export default function BotaoAlternarTema(props: BotaoAlternarTemaProps) {
    return props.tema === 'dark' ? (
        ...
        bg-gradient-to-tr from-yellow-300 to-yellow-600 w-14 lg:w-24 h-8 p-1 rounded-full
       `}>
            <div className={`
    ...
    bg-gradient-to-tr from-gray-500 to-gray-900 w-14 lg:w-24 h-8 p-1 rounded-full
    `}>
       <div className={`
